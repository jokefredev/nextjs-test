...
export default function Home() {
  const exp_definitions = require('../definitions/exported_definitions');

  const definitions = exp_definitions.definitions();

  definitions.map((element) => {
    if (element.id.includes('video')) {
      console.log ('video found: ', element);
    }
  })
